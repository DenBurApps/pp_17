...
- **Application** refers to Sporti Time me Up!, the software program provided by the Company.
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sporti Time me Up!.
...
- By email: huansui@sontfinances.site
''';
...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named Sporti Time me Up!
...
The laws of the Country, excluding its conflicts of law rules, shall govern this
 ...
 Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.
